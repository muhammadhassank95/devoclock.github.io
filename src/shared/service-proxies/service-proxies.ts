...
export class AccountServiceProxy {
  ...
  getFinancialYears(id: any): Observable<any> {
    let url_ = `${this.baseUrl}api/TokenAuth/GetAllFinancialYears?TenantId=${id}`;

    let options_: any = {
      observe: "response" as const, // 'as const' ensures the type is correctly inferred
      responseType: "json" as const, // Changed to 'json' to directly parse JSON responses
      headers: new HttpHeaders({
