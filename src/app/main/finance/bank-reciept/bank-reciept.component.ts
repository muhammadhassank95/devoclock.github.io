...
@Component({
  selector: "app-bank-reciept",
  templateUrl: "./bank-reciept.component.html",
})
export class BankRecieptComponent {
  ...
  MakeVoucher(value?: Date) {
    ...
    if (userLocationId && this.bankPaymentFG.value.issueDate) {
      this._bankPayment
        .getVoucherNumber(this.target, "BR", issueDate, userLocationId)
