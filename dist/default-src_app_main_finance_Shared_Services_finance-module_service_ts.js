"use strict";
(self["webpackChunkERP"] = self["webpackChunkERP"] || []).push([["default-src_app_main_finance_Shared_Services_finance-module_service_ts"],{

/***/ 33460:
/*!************************************************************************!*\
  !*** ./src/app/main/finance/Shared/Services/finance-module.service.ts ***!
  \************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   FinanceModuleService: () => (/* binding */ FinanceModuleService)
/* harmony export */ });
...
class FinanceModuleService {
  ...
  getAll(target, params) {
    ...
    if (params) {
      ...
      if (params.startDate) {
        searchParams.append("StartDate", moment__WEBPACK_IMPORTED_MODULE_1__(params.startDate).format("YYYY-MM-DD"));
      }
      if (params.endDate) {
        searchParams.append("EndDate", moment__WEBPACK_IMPORTED_MODULE_1__(params.endDate).format("YYYY-MM-DD"));
      }
      if (params.status) {
      ...
      if (params.showUnreconciledReceipts) {
        searchParams.append("ShowUnreconciledReceipts", params.showUnreconciledReceipts);
      }
  ...
  getAllCheackRe(target, params) {
    this.url = this.baseUrl;
    this.url += target + `/GetAll?FromChartOfAccountId=${params.FromChartOfAccountId}&ToChartOfAccountId=${params.ToChartOfAccountId}&
      StartDate=${params.startDate}&EndDate=${params.endDate}&
      ToProjectId=${params.projectTo}&FromProjectId=${params.projectFrom}&
      FromCostCenterId=${params.costCenterFrom}&ToCostCenterId=${params.costCenterTo}&
  ...
  downloadReportByClickGL(id, target) {
    debugger;
    this.url = this.baseUrl;
  ...
  GenerateCashBookReport(voucherNumber, target) {
    this.url = this.baseUrl;
    this.url += target + `/PdfReport/GenerateCashBookReport?voucherNumber=${voucherNumber}`;
    return this.http.get(this.url).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_2__.map)(response => {
      return response["result"];
    }));
  }
  ...
  updateReconciliation(dto, target) {
    debugger;
    console.log(dto);
    this.url = this.baseUrl;
  ...
  getVoucherNumber(target, prefix, issueDate, userLocationId) {
    this.url = this.baseUrl;
    this.url += target + "/GetVoucherNumber" + `?prefix=${prefix}&issueDate=${moment__WEBPACK_IMPORTED_MODULE_1__(issueDate).format("YYYY-MM-DD")}&userLocationId=${userLocationId}`;
    return this.http.get(this.url).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_2__.map)(response => {
      return response["result"];
    }));
  }
  createBulkVouchers(target, chequeNumberStart, chequeNumberEnd, isLineSeparateVoucher, bodyData) {
    debugger;
    this.url = this.baseUrl + target + "/CreateBulk";
    // Define the query parameters
    let params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__.HttpParams().set("ChequeNumberStart", chequeNumberStart).set("ChequeNumberEnd", chequeNumberEnd).set("IsLineSeparateVoucher", isLineSeparateVoucher.toString()); // Convert boolean to string
  ...
  getAllGeneralLedger(target, fromCOAId, toCOAId) {
    debugger;
    this.url = this.baseUrl;
    this.url += target + "/GetAll?FromChartOfAccountId=" + fromCOAId + "&ToChartOfAccountId=" + toCOAId;
    return this.http.get(this.url).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_2__.map)(response => {
      return response["result"];
    }));
  }
  GetAllGroupedVouchers(target, fromCOAId, toCOAId) {
    debugger;
    this.url = this.baseUrl;
  ...
  getAllGeneralLedgerForSupplier(target, supplierId) {
    debugger;
    this.url = this.baseUrl;
  ...
  getAllGeneralLedgerGroupedData(target, supplierId, filterByServiceQuotationInvoices = true) {
    debugger;
  ...
  getAllBankReconcilation(target, chartOfAccountId, startDate, finishDate) {
    debugger;
    this.url = this.baseUrl;
    this.url += target + `/GetAll?StartDate=${moment__WEBPACK_IMPORTED_MODULE_1__(startDate).format("YYYY-MM-DD")}&EndDate=${moment__WEBPACK_IMPORTED_MODULE_1__(finishDate).format("YYYY-MM-DD")}
  ...
  getRequetDetails(target, vehicleId, projectId, costCenterId, regionId, locationId, date) {
    debugger;
    this.url = this.baseUrl;
    this.url += target + `/FetchFuelRequestDetails?VehicleId=${vehicleId}
      &ProjectId=${projectId}
      &CostCenterId=${costCenterId}
      &RegionId=${regionId}
      &LocationId=${locationId}
      &ConsmptionMonth=${moment__WEBPACK_IMPORTED_MODULE_1__(date).format("YYYY-MM")}
      `;
    debugger;
    return this.http.get(this.url).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_2__.map)(response => {
      console.log(response);
  ...
  getGeneralLedgerReportFilters(target, startDate, endDate, fromSupplierId, toSupplierId, fromClientId, toClientId, fromPattyId, toPattyId, fromChartOfAccountId, toChartOfAccountId, fromProjectId, toProjectId, fromCostCenterId, toCostCenterId, locationId, fromEmployeeId, toEmployeeId,
  // regionId?: number,
  status, IsDropdown, skipCount, max) {
    debugger;
    debugger;
    ...
    // }
    if (startDate) {
      queryParams.push(`StartDate=${moment__WEBPACK_IMPORTED_MODULE_1__(startDate).format("YYYY-MM-DD")}`);
    }
    if (endDate) {
      queryParams.push(`EndDate=${moment__WEBPACK_IMPORTED_MODULE_1__(endDate).format("YYYY-MM-DD")}`);
    }
    if (fromSupplierId) {
  ...
  static #_ = this.ɵfac = function FinanceModuleService_Factory(t) {
    return new (t || FinanceModuleService)(_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_3__.HttpClient));
  };
  static #_2 = this.ɵprov = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineInjectable"]({
    token: FinanceModuleService,
    factory: FinanceModuleService.ɵfac,
    providedIn: "root"
  });
}
...
//# sourceMappingURL=default-src_app_main_finance_Shared_Services_finance-module_service_ts.js.map